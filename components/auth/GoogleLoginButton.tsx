...
export function GoogleLoginButton() {
  const handleGoogleLogin = () => {
    ...
    window.location.href = `${publicEnv.apiUrl}/auth/google/login?redirect_to=${redirectTo}`;
  };
  ...
  return (
    ...
    >
      ...
      {publicEnv.googleLoginEnabled
        ? "Continuar con Google"
        : "Inicio de sesion con Google no disponible"}
    </button>
  );
}
